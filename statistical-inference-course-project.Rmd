...
The sample variance is `r var(sim.means)` and the theoretical variance is `r (1/lambda)^2/length(sim.means)` - the difference is `r var(sim.menas) - ((1/lambda)^2/length(sim.means))`
